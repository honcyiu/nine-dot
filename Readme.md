...
- Accurate line-cursor mapping across multiple screen sizes
- Additional challenges / training rounds
- Social exposure could be updated such that players can see what each other are drawing in real time
